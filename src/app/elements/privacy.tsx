	...
	return (
		<>
			...
			<div className="callout-body">
                All applications created by PixelVivid are privacy respecting applications. We go out of our way to keep as little information about users as possible.<br/>
				<br/>
				...
				<br/>
                PixelVivid applications are a serverless applications that runs in a data center hosted by AWS in Ohio. We do not explicitly share anything with Amazon but they could have access to our systems if they chose to. We have no reason nor intention to transfer data outside the US.<br/>
				<br/>
                If you'd like to know more about anything we do with regards to your data, please email us at brian.whaley@PixelVivid.tech.
				<br/>
			</div>
		</>
	);
