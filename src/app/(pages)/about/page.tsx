							...
							<div className="row-1col">
								...
								<div className="gridItem">
									<Callout
										...
										Once all the colors are applied, each pair of sunglases are sprayed 
										...
										the designer to sign their work. Each pair unique, earth-friendly and fun! '
										layout='horizontal' />
								</div>
